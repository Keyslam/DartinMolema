...
internal class NewMatchScreen : Screen
{
    ...
    public NewMatchScreen(DependencyContainer dependencyContainer) : base(dependencyContainer)
    {
        ...
        this.dayInput = this.MatchBuilder.Result.Date.Day;
        this.monthInput = this.MatchBuilder.Result.Date.Month;
        this.yearInput = this.MatchBuilder.Result.Date.Year;
        this.hourInput = this.MatchBuilder.Result.Date.Hour;
        this.minuteInput = this.MatchBuilder.Result.Date.Minute;
    }
    ...
    private void StartMatch()
    {
        ...
        var match = this.MatchBuilder.Result;
