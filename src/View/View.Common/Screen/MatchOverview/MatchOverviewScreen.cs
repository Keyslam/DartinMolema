...
internal class MatchOverviewScreen : Screen
{
	...
	public MatchOverviewScreen(Match match, DependencyContainer dependencyContainer) : base(dependencyContainer)
	{
		...
		// this.Match.Players
		// 	.Select(playerReference => this.PlayerReferenceLoader.Resolve(playerReference));

		// this.Winner = this.Match.WinnerIndex == null ? null : this.PlayerReferenceLoader.Resolve(this.Match.WinnerIndex);
	...
	public override void Update()
	{
		...
		// 	foreach (var playerReference in this.Match.Players)
		// 	{
		// 		var player = this.PlayerReferenceLoader.Resolve(playerReference);
		// 		var matchStatistic = this.Match.Statistics[playerReference];
		...
		// 	{
		// 		var player = this.PlayerReferenceLoader.Resolve(playerReference);
		// 		var setStatistic = this.Match.Sets[this.SelectedSet].Statistics[playerReference];
		...
		// 			ImGui.TableNextColumn();
		// 			if (leg.WinnerIndex != null)
		// 			{
		// 				var winnerName = this.PlayerReferenceLoader.Resolve(leg.WinnerIndex);
