...
#pragma warning restore 8618
    ...
    public bool PlayTurn(List<(ThrowKind throwKind, int value)> throws)
    {
        ...
        var remainingPoints = legStatistic.RemainingPoints;
        var newRemainingPoints = this.GetRemainingPointsAfterTurn(throws);

        var turnScore = remainingPoints - newRemainingPoints;
        ...
        foreach (var throwData in throws)
        {
            var @throw = new Throw()
            {
                ...
                AssignedValue = remainingPoints == newRemainingPoints ? 0 : throwData.value,
            };
